...
def eval(make_index: ReferenceIndex, make_extender: Extender) -> None:
    """
    ...
    for ref_prefix in ref_prefixes:
        ...
        for sequences, sam_ref in tqdm.tqdm(zip(stream_fastq_pair(f1, f2), zip(*[sam.fetch()] * 2))):
            r1, r2 = sequences
